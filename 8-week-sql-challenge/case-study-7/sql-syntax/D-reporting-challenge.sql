...
WHERE start_txn_time >= date_trunc('month', current_date - interval '1 MONTH')
    AND start_txn_time < date_trunc('month', current_date);
...
WITH cte_products AS(
    ...
    WHERE s.start_txn_time >= date_trunc('month', current_date - interval '1 MONTH')
        AND s.start_txn_time < date_trunc('month', current_date)
),
