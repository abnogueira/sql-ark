...
WHERE start_txn_time >= date_trunc('month', '2021-02-01'::date - interval '1 MONTH')
    AND start_txn_time < date_trunc('month', '2021-02-01'::date);
...
WITH cte_products AS(
    ...
    WHERE s.start_txn_time >= date_trunc('month', '2021-02-01'::date - interval '1 MONTH')
        AND s.start_txn_time < date_trunc('month', '2021-02-01'::date)
),
